        ...
        <>
            <div style={{ background: `url(${isMobile ? bgSmall : imageUrl}) right / cover no-repeat` }} className='h-[100dvh] slide'>
                <div className="relative top-[40px]">
                    <div className="container mx-auto px-[20px] xl:px-0 h-[calc(100dvh-80px)] xl:h-[calc(100dvh-40px)] overflow-y-scroll">
                                    ...
                                    <div className="col-span-8 flex flex-col items-center justify-center lg:pr-[30px] pt-[20px] lg:pt-0">
                                        {(data?.slidable?.document?.url && locale) && (
                                            <img src={data.slidable.document.optimized_url.large.url} 
                                                ...
                                                className="w-full md:w-[60%] lg:w-auto lg:h-[calc(100dvh-200px)] object-contain cursor-pointer"
                                        ...
                                        {data?.slidable?.document?.url &&                                        
                                            <div className="mt-5 cursor-pointer flex justify-center" onClick={() => { navigate(`/resources/${data?.slidable?.document.id}`, { state: { modal: true, previousLocation: location } }) }}>
