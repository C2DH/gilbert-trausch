        ...
        <>
            <div className="relative">
                ...
                { data.slidable.document &&              
                    <div className="absolute bottom-[50px] xl:bottom-[15px] left-[50%] -translate-x-[50%] cursor-pointer" onClick={() => { navigate(`/resources/${data?.slidable?.document.id}`, { state: { modal: true } }) }} >
