    ...
    return (
        <>
            <div className="relative">
                ...
                {/** IMAGES / PDF */}
                { data?.slidable?.document?.type === "image" &&
                    <div className="h-screen w-full flex items-center justify-center" style={{ background: `url(${data?.slidable?.document?.url}) center / cover no-repeat` }}>
                    </div>
                }
