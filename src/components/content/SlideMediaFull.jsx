    ...
    return (
        <>
            <div className="relative">
                ...
                { data.slidable.document &&              
                    <div className="absolute bottom-[50px] lg:bottom-[15px] left-[50%] -translate-x-[50%] cursor-pointer" onClick={() => { setIsOpenPopup(true); setDataPopup(data.slidable?.document); }} >
